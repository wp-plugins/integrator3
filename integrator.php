 ...
 * @version    3.0.7 ( $Id: integrator.php 142 2012-11-28 02:28:39Z steven_gohigher $ )
...
define( 'INTEGRATOR_VERSION', "3.0.7" );
...
class Integrator
{
	...
	public function admin_init_box_intlink()
	{
		...
		include( dirname(__FILE__) . '/integrator/box.php' );
	}
	...
	public function admin_options()
	{
		...
		include( dirname(__FILE__) . '/integrator/options.php' );
	...
	public function site_intlink_redirect()
	{
		...
		if ( have_posts() ) {
			...
			if ( isset( $_GET['override'] ) )  {
				...
				if (! $data['result'] ) {
					include( dirname( __FILE__ ) . '/integrator/intlinkerror.php');
					die();
				}
